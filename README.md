...
- Full viewport hero with floating orb animation and stats bar
- Live countdown section with pulsing dot
- Speaker grid with staggered card reveal animations
- Featured speaker split section
- Full schedule table with sticky heading
- Three-tier ticket section
- About section with CSS columns and blockquote
- Sponsor tiers with brand colour hover effects
- Venue split section
